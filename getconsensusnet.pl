...
$timestamp = localtime();
print "Job started  at ".$timestamp."\n";
...
$dirname = $dir;
$dirname =~ s/\///;
my $outfile = ${dirname}."_bs".${totbs}."_info.txt";
...
$pthres = 0.05/$totedge unless (defined $pthres);
...
$outfile = ${dirname}."_bs".${totbs}."_p".${ealpha}.".adj";
...
print "Job finished at ".$timestamp."\n";
